...
accesorioArray.push(new Accesorios(103, "Mila Set", 590, 25, "Set of seven golden rings", "../assets/img/a3.jpg"));
...
accesorioArray.push(new Accesorios(117, "Betty Set", 600, 25, "Set of silver ring earrings and a chain", "../assets/img/a17.jpg"));
...
const agregarProductosTienda = (array) => {
...
agregarProductosTienda(accesorioArray);

// SORT BY

const sortByBoton = document.querySelector(".button__sortby");
const sortByDropdown = document.querySelector(".dropdownmenu__sortby");
sortByBoton.addEventListener("click", function() {
    if(sortByDropdown.style.display === "block") {
...
const highLowBoton = document.querySelector(".filter__high");
const accesorioDiv = document.querySelector(".accesories__div");
highLowBoton.style.cursor = "pointer";
highLowBoton.onclick = () => highLowFiltro();

const highLowFiltro = () => {
    accesorioArray.sort(highLow);
    console.log(accesorioArray);
    contenedorAccesorios.removeChild(accesorioDiv);
    agregarProductosTienda(accesorioArray);
}
